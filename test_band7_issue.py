#!/usr/bin/env python3
"""Test the Band 7 issue with 0% accuracy on 1 complex attempt."""
...
print(f"\n{'='*60}")
print(f"BAND 7 ISSUE TEST")
print(f"{'='*60}")
print(f"\nSample: 1 complex attempt @ 0% accuracy, 79.3 WPM, 1 filler")
print(f"\nResults:")
...
print(f"\nExpected:")
print(f"  Grammar should be 7.0 or lower (0% accuracy = -2.5: -1.0 for low attempts + -1.5 for 0% accuracy)")
print(f"  Overall should be 5.5-6.0 (with weak fluency 6.0, this should drag down overall)")
